  ...
  return (
    ...
    <div className='auth'>
      ...
      <div className="state state--default">
        ...
        <p>
          <span style={{ "--i": 0 }}>St</span>
          <span style={{ "--i": 1 }}>ud</span>
          <span style={{ "--i": 2 }}>en</span>
      ...
      <div className="state state--sent">
        ...
        <p>
          <span style={{ "--i": 5 }}>Re</span>
          <span style={{ "--i": 6 }}>di</span>
          <span style={{ "--i": 7 }}>re</span>
          <span style={{ "--i": 8 }}>ct</span>
          <span style={{ "--i": 9 }}>in</span>
          <span style={{ "--i": 10 }}>g</span>
           ...
           <button
             className="button"
             onClick={() => handleUserTypeSelection('interviewer')}
           >
             <div className="outline"></div>
      <div className="state state--default">
        <div className="icon">
        ...
        <p>
          <span style={{ "--i": 0 }}>In</span>
          <span style={{ "--i": 1 }}>te</span>
          <span style={{ "--i": 2 }}>vi</span>
          <span style={{ "--i": 3 }}>wer</span>
      ...
      <div className="state state--sent">
        ...
        <p>
          ...
          <span style={{ "--i": 10 }}>g</span>
           ...
           <button
             className="button"
             onClick={() => handleUserTypeSelection('faculty')}
           >
              <div className="outline"></div>
      <div className="state state--default">
        <div className="icon">
        ...
        <p>
          ...
          <span style={{ "--i": 10 }}>g</span>
            ...
            <div className="form-container">
              <h1 style={{textAlign:"center",textTransform:"capitalize"}}>{activeForm}</h1>
              ...
              <div className="form-inner">
                ...
                {activeForm === 'login' && userType==='faculty' && navigate('/faculty-auth')}
              </div>
            </div>
